...
int main(int argc, char** argv) {
    ...
    double initial_learning_rate = atof(argv[5]);
    double final_learning_rate = atof(argv[6]);
    ...
    printf("********************************************************************************\n");
    initialise_optimiser(learning_rate, batch_size, total_epochs, initial_learning_rate, final_learning_rate, alpha);
